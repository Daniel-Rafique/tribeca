...
##   $ docker build -t node-js-for-daniel-rafique-tribeca .
##
## RUNNING
##   $ docker run -p 3000:3000 node-js-for-daniel-rafique-tribeca
##
## CONNECTING
...
ENV STACKSMITH_STACK_ID="ubtxzzy" \
    STACKSMITH_STACK_NAME="Node.js for Daniel-Rafique/tribeca" \
